<div class="side-body" id="main-content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-2 col-md-3 col-md-offset-1" id="middle-button-container">
    ...
    <div class="container" ng-show="exchangeOptionExists">


        <div class="row bs-wizard" style="border-bottom:0;">

            <div class="col-xs-3 bs-wizard-step complete" ng-repeat="username in exchangeOptionPath">
                <!-- complete -->
