<div class="side-body" id="main-content">
    ...
    <div ng-repeat="bookExchange in userExchangeHistory" class="col-xs-12">
             ...
             <div class="col-xs-12 col-sm-4 col-sm-offset-1 col-md-4 col-md-offset-1">
              ...
              <div id="arrow-right-container" class="text-center">
                        <i class="fa fa-4x" ng-class="{'fa-arrow-right': bookExchange.offered, 'fa-arrow-left': !bookExchange.offered}"></i>
                        </div>
               </div>
