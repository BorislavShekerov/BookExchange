<div class="row chainRequestModal">
	...
	<div class="modal-body">
		<div>
			...
			<div class="row">
				<button class="btn btn-primary pull-right" type="button" ng-click="acceptExchangeChainRequest()">Accept</button>
				<button class="btn btn-danger pull-left" type="button" ng-click="rejectExchangeChainRequest()">Reject</button>
			</div>
		</div>
